...
const char HTTP_FORM_START_PWD[] PROGMEM  = "<form method='get' action='wifisave'><input id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='password' placeholder='password'><br/>";
...
class WiFiManager
{
  public:
    ...
    // If hide is false, password entry box will not hide password.
    // Useful where ease of entry is more important that security
    void          hidePassword(boolean hide);
